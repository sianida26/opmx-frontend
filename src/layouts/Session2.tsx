...
export default function Session2() {
	...
	useEffect(() => {
		...
		//find object
		const title = session2.find((x) => x.page === page)?.title ?? "OPMX";
	...
	return (
		<div className="w-screen overflow-x-hidden">
			<section
				id="landing-cover"
				className="relative w-full lg:shadow-xl lg:border-b-2 lg:border-primary-800"
			>
				{/* content */}
			...
			<div className="flex flex-col text-xs gap-4 md:flex-row md:justify-between w-full max-w-screen-lg mx-auto px-6 pb-4 poppins">
				...
				>
					<div className="flex flex-col">
						...
						<p>
							{session2.find((x) => x.page === currentPage + 1)
								?.title ?? "End of Course"}
						</p>
					</div>
