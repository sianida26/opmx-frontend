...
export default function ObjectiveCheckbox({
	...
	return (
		<button onClick={ handleClick } className="bg-slate-200 border w-full border-slate-600 rounded-lg flex justify-between p-4 items-center text-left gap-2 md:gap-4 text-sm">
